...
"""
To use Together.AI service, you need to refister and receive an API key.
You can find your API key in your profile page.
In the terminal, run the following command: export TOGETHER_API_KEY=xxxx..xxxxxxx
This will temporarily set the environment variable TOGETHER_API_KEY.
You can check:
print("API key:", os.environ.get("TOGETHER_API_KEY"))
"""
